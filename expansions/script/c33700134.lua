...
function c33700134.initial_effect(c)
	...
	e0:SetCondition(c33700134.spcon)
	e0:SetOperation(c33700134.spop)
...
function c33700134.ovfilter(c,g)
	return c:IsSetCard(0x443)  and c:IsFaceup()  and c:IsCanBeXyzMaterial(g)
end
function c33700134.spcon(e,c)
	if  Duel.IsExistingMatchingCard(c33700134.ovfilter,e:GetHandlerPlayer(),LOCATION_MZONE,0,2,nil,e:GetHandler()) then return true
	else return false end
end
function c33700134.spop(e,tp,eg,ep,ev,re,r,rp,c) 
	local c=e:GetHandler()
	local g=Duel.SelectMatchingCard(tp,c33700134.ovfilter,e:GetHandlerPlayer(),LOCATION_MZONE,0,2,2,nil,e:GetHandler())
