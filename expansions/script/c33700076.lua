...
function c33700076.reop(e,tp,eg,ep,ev,re,r,rp)
	local g=Duel.GetMatchingGroup(c33700076.confilter,tp,LOCATION_GRAVE,0,nil) 
   if g:GetClassCount(Card.GetCode)>=3 or  Duel.IsExistingMatchingCard(c33700076.jfilter,tp,LOCATION_SZONE,0,1,nil) then
	Duel.Recover(tp,1000,REASON_EFFECT)
end
   if g:GetClassCount(Card.GetCode)>=7  or Duel.IsExistingMatchingCard(c33700076.jfilter,tp,LOCATION_SZONE,0,1,nil) then
